...
<%@ page import="org.jbpm.formModeler.core.processing.fieldHandlers.checkboxList.CheckboxListFieldHandlerFormatter" %>
<%@ taglib uri="mvc_taglib.tld" prefix="mvc" %>
<%@ taglib uri="http://jakarta.apache.org/taglibs/i18n-1.0" prefix="i18n" %>
<%try{%>
<mvc:formatter name="CheckboxListFieldHandlerFormatter">
    <mvc:formatterParam name="<%=CheckboxListFieldHandlerFormatter.PARAM_MODE%>" value="<%=CheckboxListFieldHandlerFormatter.MODE_INPUT%>"/>
...
%>
    ...
    <mvc:fragment name="outputCheckbox">
...
<%}catch(Throwable t){System.out.println("Error showing CheckboxList: " + t);t.printStackTrace();}%>
